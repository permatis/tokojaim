...
<!--theme-style-->
<link href="{{ URL::asset('asset/css/style4.css') }}" rel="stylesheet" type="text/css" media="all" />
<!--//theme-style-->
<script src="{{ URL::asset('asset/js/jquery.min.js') }}"></script>
<!--- start-rate---->
<script src="{{ URL::asset('asset/js/jstarbox.js') }}"></script>
	<link rel="stylesheet" href="{{ URL::asset('asset/css/jstarbox.css') }}" type="text/css" media="screen" charset="utf-8" />
    		...
    		<li class="dropdown mega-dropdown active">
				...
				<div class="dropdown-menu ">
                    <div class="menu-top">
						...
						<div class="col1 col5">
						<img src="asset/images/me.png" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
...
<ul>
						...
						<div class="col1 col5">
						<img src="asset/images/me1.png" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
			...
			<div class="col-sm-2 search-right">
				...
				<li><a class="play-icon popup-with-zoom-anim" href="#small-dialog"><i class="glyphicon glyphicon-search"> </i></a></li>
					...
					<div class="cart box_1">
						<a href="/checkout">
						<h3> <div class="total">0.00000</div>
					...
					<div class="clearfix"> </div>
						...
						<!---pop-up-box---->
			<link href="{{ URL::asset('asset/css/popuo-box.css') }}" rel="stylesheet" type="text/css" media="all"/>
			<script src="{{ URL::asset('asset/js/jquery.magnific-popup.js') }}" type="text/javascript"></script>
			<!---//pop-up-box---->
			...
			<div class="footer-bottom">
				<div class="container">
					<ul class="footer-bottom-top">
						<li><a href="#"><img src="asset/images/f1.png" class="img-responsive" alt=""></a></li>
						<li><a href="#"><img src="asset/images/f2.png" class="img-responsive" alt=""></a></li>
						<li><a href="#"><img src="asset/images/f3.png" class="img-responsive" alt=""></a></li>
					</ul>
...
<script src="{{ URL::asset('asset/js/simpleCart.min.js') }}"> </script>
<!-- slide -->
<script src="{{ URL::asset('asset/js/bootstrap.min.js') }}"></script>
<!--light-box-files -->
		<script src="{{ URL::asset('asset/js/jquery.chocolat.js') }}"></script>
		<link rel="stylesheet" href="{{ URL::asset('asset/css/chocolat.css') }}" type="text/css" media="screen" charset="utf-8">
		<!--light-box-files -->
