		...
		<div class="col-md-9 top-in-single">
			<div class="col-md-5 single-top">	
				<ul id="etalage">
					...
					<li>
						<img class="etalage_thumb_image img-responsive" src="{{ URL::asset('assets/images/si1.jpg') }}" alt="" >
			...
			<div class="single-bottom">
				<h4>Product Categories</h4>
					<div class="product-go">
						<img class="img-responsive fashion" src="{{ URL::asset('assets/images/fa.jpg') }}" alt="">
					...
					<div class="product-go">
						<img class="img-responsive fashion" src="{{ URL::asset('assets/images/fa1.jpg') }}" alt="">
					<div class="grid-product">
						<a href="#" class="elit">Consectetuer adipiscing elit</a>
						<span class=" price-in"><small>$500.00</small> $400.00</span>
					</div>
					...
					<div class="product-go">
						<img class="img-responsive fashion" src="{{ URL::asset('assets/images/fa2.jpg') }}" alt="">
					<div class="grid-product">
						<a href="#" class="elit">Consectetuer adipiscing elit</a>
						<span class=" price-in"><small>$500.00</small> $400.00</span>
					</div>
